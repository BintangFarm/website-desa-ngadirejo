      ...
      <section className="bg-white pt-2 pb-12">
        <div className="container mx-auto px-4 md:px-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { icon: <Store className="w-5 h-5" />, value: "79", label: "UMKM Terdaftar", accent: "bg-emerald-50 text-emerald-600" },
        ...
        <div className="container mx-auto px-4 md:px-10 relative z-10">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-6 space-y-3.5">
              ...
              <div className="border-t border-white/10 pt-4">
                <div className="flex items-center justify-between text-sm mb-1">
                  ...
                  <span className="font-bold text-emerald-400 text-base">79</span>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
            {[
              ...
              { icon: <Store className="w-5 h-5" />, title: "Sebaran Usaha", desc: "79 UMKM tersebar di seluruh dusun Desa Ngadirejo", color: "text-blue-400 bg-blue-500/10" },
